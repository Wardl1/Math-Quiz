"""08 Export GUI version 4
Continues on from version 3
Export button on Results GUI is now disabled when Export GUI is opened
    - line 402
Close button in the top right of the export GUI re enables the Export button
    - line 409, 410
Cancel button on Export GUI re enables Export button on the Results GUI
    - line 473
Save button on Export GUI now closes the Export GUI
    - line 518 - 520
"""
