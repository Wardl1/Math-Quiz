"""10 Math Quiz Assembled version 1
combines 08_Export_GUI_v4 and 09_Warning_GUI_v2
(08_Export_GUI_v4 contains all prior components apart from warning GUI)
line 243 - if close button on Question GUI is pressed
then warning GUI will open
line 528 - creates child window for warning GUI
line 575 - closes warning GUI when close is pressed
line 578 - opens export GUI when export button on warning GUI is pressed
"""
...
class ExportGUI:
    def __init__(self, partner, results):
        # Formatting variables
    ...
    def cancel_export(self, partner):
        self.export_box.destroy()  # closes export GUI
        partner.export_button.config(state=NORMAL)

    def save_results(self, partner):
...
class WarningGUI:
    def __init__(self, partner):
        ...
        self.export_button = Button(self.button_frame, text="Export",
                                    width=8, bg="light grey",
                                    font="arial 10 bold",
                                    command=partial(self.open_export, partner))
    ...
    def open_export(self, partner):
        ExportGUI(self, results=partner.question_results)
