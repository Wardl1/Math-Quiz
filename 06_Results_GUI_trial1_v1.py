...
results = ['5 + 1 = ', 6, 'Correct', 6], ['1 + 2 = ', 3, 'Correct', 3], ['0 + 5 = ', 5, 'Correct', 5], \
          ['5 + 0 = ', 5, 'Correct', 5], ['10 + 10 = ', 20, 'Correct', 20], ['5 + 3 = ', 8, 'Correct', 8], \
          ['6 + 10 = ', 16, 'Correct', 16], ['4 + 7 = ', 11, 'Correct', 11], ['2 + 8 = ', 10, 'Correct', 10], \
          ['2 + 3 = ', 5, 'Correct', 5]
...
class ResultsGUI:
    def __init__(self, results_list):
        ...
        # set up GUI Frame
        self.history_frame = Frame(width=300, height=300, pady=10, bg=background)
        ...
        for item in results_list:  # each question
            for sub_item in item:  # each part of each question e.g. user input, question
                if isinstance(sub_item, int):  # if sub_item is an integer
                    sub_item_str = str(sub_item)  # converts to string
                    results_string += sub_item_str  # adds sub_item to the results string
