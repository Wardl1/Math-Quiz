...
line 277 and 280 Enter button disappears and results button appears after 10
questions
line 287 and 288 function to open Results GUI when results button is pressed
line 292 add partner to Results GUI
line 296 disables results button on question GUI
line 299 set up child window for Results GUI
line 303-304 if users presses close at top it closes results GUI and enables
results button on Question GUI
line 385-388 close button now re enables results button on Question GUI and
closes Results GUI
"""
