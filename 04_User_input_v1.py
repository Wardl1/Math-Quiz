...
This component carries on from component 3 but now collects input from user
input is evaluated and colour changes in the entry box and wording happen accordingly
enter button is disabled after it has been pressed and re enabled when next button is pressed
need to fix issue where next button can be pressed before enter button
"""
