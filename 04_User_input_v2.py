"""Component 04 User input
This component carries on from version 1
next button is now disabled when it has been pressed and when enter button is pressed it is re enabled
unless user input is invalid where the next button will stay disabled
"""
...
class QuestionGUI:
    ...
    def generate_question(self):
        ...
        self.question_label.config(
            text=question)  # changes question label so that it is the
        self.question_heading_label.config(
            text="Question {}/10".format(self.question_number))
    ...
    def enter_question(self):
        ...
        # Add Answer to list for results history
